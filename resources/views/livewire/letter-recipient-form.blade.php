<form wire:submit.prevent="save"
    ...
    <div class="col-span-1 md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6">
        @if($is_professional)
            @include('front-end._partials.forms.professional', ['person' => 'recipient'])
        @else
            @include('front-end._partials.forms.personal', ['person' => 'recipient'])
        @endif
