...
<div
    ...
    x-init="() => init($refs.editor, {{ $isEditable ? 'true' : 'false' }})"
    wire:ignore
    {{ $attributes->whereDoesntStartWith('wire:model') }}
>
    <div class="flex justify-end gap-1" x-show="editor.isEditable">
        <div
            class="w-10 h-10 cursor-pointer flex items-center justify-center text-xs bg-white border border-b-[3px] border-gray-200 rounded-sm"
